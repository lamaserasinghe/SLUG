...
import lk.uordcs.SLUG.Adapter_Classes.FootballAdapter;
...
public class FootballActivity extends AppCompatActivity {
    public FootballAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call call=apiInterface.getFootballResults();
            ...
            public void onResponse(Call call, Response response) {
                try{
                    if(response.body()!=null){
                        ...
                        resultsList=(List<FootballResults>)response.body();
                         adapter = new FootballAdapter(FootballActivity.this, resultsList);
