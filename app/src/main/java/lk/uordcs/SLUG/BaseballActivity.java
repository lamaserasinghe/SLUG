package lk.uordcs.SLUG;
        ...
        import lk.uordcs.SLUG.Adapter_Classes.BaseballAdapter;
...
public class BaseballActivity extends AppCompatActivity {
    ...
    public BaseballAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call call=apiInterface.getBaseballResults();
                ...
                try{
                    if(response.body()!=null){
                        progressDialog.dismiss();
                         resultsList=(List<BaseballResults>)response.body();
                         adapter = new BaseballAdapter(BaseballActivity.this, resultsList);
