...
public class HurdlesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Hurdles");
        ...
        Call call=apiInterface.getHurdles();
            ...
            public void onResponse(Call call, Response response) {
                try{
                    if(response.body()!=null){
                        ...
                        adapter = new RunningAdapter(HurdlesActivity.this, resultsList);
