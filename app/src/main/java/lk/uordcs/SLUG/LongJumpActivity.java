...
public class LongJumpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Long Jump");
        ...
        Call call=apiInterface.getLongJumpResults();
            ...
            public void onResponse(Call call, Response response) {
                try{
                    if(response.body()!=null){
                        ...
                        adapter = new JumpingAdapter(LongJumpActivity.this, resultsList);
