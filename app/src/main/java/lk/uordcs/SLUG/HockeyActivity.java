...
import lk.uordcs.SLUG.Adapter_Classes.HockeyAdapter;
...
public class HockeyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call call=apiInterface.getHockeyResults();
                ...
                try{
                    if(response.body()!=null){
                        progressDialog.dismiss();
                         resultsList=(List<HockeyResults>)response.body();
                         adapter = new HockeyAdapter(HockeyActivity.this, resultsList);
