...
public class RugbyFootballActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rugby_football);
                ...
                try{
                    if(response.body()!=null){
                        ...
                        resultsList=(List<RugbyFootballResults>)response.body();
                         adapter = new RugbyFootballAdapter(RugbyFootballActivity.this, resultsList);
