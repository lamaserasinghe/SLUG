...
public class TripleJumpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Triple Jump");
        ...
        Call call=apiInterface.getTripleJumpResults();
            ...
            public void onResponse(Call call, Response response) {
                try{
                    if(response.body()!=null){
                        ...
                        adapter = new JumpingAdapter(TripleJumpActivity.this, resultsList);
