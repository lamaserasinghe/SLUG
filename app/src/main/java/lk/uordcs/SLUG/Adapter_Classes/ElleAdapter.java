...
public class ElleAdapter extends RecyclerView.Adapter<ElleAdapter.ElleViewHolder> implements Filterable {
    private Context mCtx;
    private List<ElleResults> resultsList;
    private List<ElleResults> resultsListFull;


    public ElleAdapter(Context mCtx, List<ElleResults> resultsList) {
        this.mCtx = mCtx;
    ...
    public ElleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.badminton_result_card, null);
        return new ElleViewHolder(view);
    }

    public void onBindViewHolder(ElleViewHolder holder, int position) {
        //getting the product of the specified position
        ElleResults results=resultsList.get(position);
    ...
    class ElleViewHolder extends RecyclerView.ViewHolder {
        ...
        public ElleViewHolder(View itemView) {
            super(itemView);
    ...
    private Filter resultFilter=new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<ElleResults> filteredList=new ArrayList<>();
            ...
            if(constraint==null || constraint.length()==0){
                ...
                for(ElleResults item:resultsListFull){
