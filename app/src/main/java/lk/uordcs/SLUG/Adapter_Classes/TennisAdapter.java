...
public class TennisAdapter extends RecyclerView.Adapter<TennisAdapter.TennisViewHolder> implements Filterable {
    private Context mCtx;
    private List<TennisResults> resultsList;
    private List<TennisResults> resultsListFull;


    public TennisAdapter(Context mCtx, List<TennisResults> resultsList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(TennisViewHolder holder, int position) {
        ...
        TennisResults results = resultsList.get(position);
    ...
    private Filter resultFilter=new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<TennisResults> filteredList=new ArrayList<>();
            ...
            if(constraint==null || constraint.length()==0){
                ...
                for(TennisResults item:resultsListFull){
