...
public class NetballAdapter extends RecyclerView.Adapter<NetballAdapter.NetballViewHolder> implements Filterable {
    private Context mCtx;
    private List<NetballResults> resultsList;
    private List<NetballResults> resultsListFull;


    public NetballAdapter(Context mCtx, List<NetballResults> resultsList) {
        this.mCtx = mCtx;
    ...
    public NetballViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.netball_result_card, null);
        return new NetballViewHolder(view);
    }

    public void onBindViewHolder(NetballViewHolder holder, int position) {
        //getting the product of the specified position
        NetballResults results=resultsList.get(position);
    ...
    class NetballViewHolder extends RecyclerView.ViewHolder {
        ...
        public NetballViewHolder(View itemView) {
            super(itemView);
    ...
    private Filter resultFilter=new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<NetballResults> filteredList=new ArrayList<>();
            ...
            if(constraint==null || constraint.length()==0){
                ...
                for(NetballResults item:resultsListFull){
