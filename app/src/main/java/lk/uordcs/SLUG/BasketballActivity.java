...
import lk.uordcs.SLUG.Adapter_Classes.BasketballAdapter;
...
public class BasketballActivity extends AppCompatActivity {
    public BasketballAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call call=apiInterface.getBasketballResults();
                ...
                try{
                    if(response.body()!=null){
                        progressDialog.dismiss();
                         resultsList=(List<BasketballResults>)response.body();
                         adapter = new BasketballAdapter(BasketballActivity.this, resultsList);
