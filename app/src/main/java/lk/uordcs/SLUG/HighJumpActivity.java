...
public class HighJumpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("High Jump");
            ...
            public void onResponse(Call call, Response response) {
                try{
                    if(response.body()!=null){
                        ...
                        adapter = new JumpingAdapter(HighJumpActivity.this, resultsList);
