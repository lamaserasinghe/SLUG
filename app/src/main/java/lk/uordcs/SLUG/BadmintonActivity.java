...
public class BadmintonActivity extends AppCompatActivity {
    ...
    public BadmintonAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call call=apiInterface.getBadmintonResults();
                ...
                try{
                    if(response.body()!=null){
                        progressDialog.dismiss();
                         resultsList=(List<BadmintonResults>)response.body();
                         adapter = new BadmintonAdapter(BadmintonActivity.this, resultsList);
