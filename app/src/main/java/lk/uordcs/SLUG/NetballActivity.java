package lk.uordcs.SLUG;
        ...
        import lk.uordcs.SLUG.Adapter_Classes.NetballAdapter;
...
public class NetballActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Netball");
        ...
        Call call=apiInterface.getNetballResults();
            ...
            public void onResponse(Call call, Response response) {
                try{
                    if(response.body()!=null){
                        ...
                        resultsList=(List<NetballResults>)response.body();
                         adapter = new NetballAdapter(NetballActivity.this, resultsList);
